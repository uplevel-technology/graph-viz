import {AnalyticsServiceClient} from '@core/services/analytics_service_pb_service'
...
import {ANALYTICS_SERVICE_ADDRESS} from '../App'
...
class DevGraphBase extends React.Component<Props, State> {
  client = new AnalyticsServiceClient(ANALYTICS_SERVICE_ADDRESS)

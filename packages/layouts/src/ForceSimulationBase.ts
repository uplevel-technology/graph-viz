...
export class ForceSimulationBase {
  public thread: 'main' | 'worker'

  protected simulation: D3Simulation | undefined
  ...
  protected readonly config: Required<ForceConfig> = FORCE_DEFAULTS

  protected defaultLinkForceStrengths: number[] = []

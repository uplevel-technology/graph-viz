...
export const artifactToTooltipNode = (artifact: Artifact): Partial<TooltipNode> => ({
  displayName: getArtifactNodeLabel(artifact.getType()),
})

export const attributeToNode = (attribute: Attribute): Partial<GraphVizNode> => ({
...
export const attributeToTooltipNode = (attribute: Attribute): Partial<TooltipNode> => ({
  displayName: getAttributeNodeLabel(attribute.getType()),
})

export const observableToNode = (observable: ObservableNode): Partial<GraphVizNode> => {
...
export const observableToTooltipNode = (observable: ObservableNode): Partial<TooltipNode> => {
  switch (observable.getValueCase()) {
  case ObservableNode.ValueCase.ARTIFACT:
...
export const eventsToVizData = (events: Event[]): {
